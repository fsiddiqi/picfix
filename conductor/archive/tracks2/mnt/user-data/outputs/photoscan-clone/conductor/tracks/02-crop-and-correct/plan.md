...
- [ ] Task 3.3: Performance
  - [ ] 3.3.1 Benchmark full pipeline on a 12MP fixture image in desktop
        Chrome
  - [ ] 3.3.2 Re-benchmark on a real mid-range Android device (WASM perf
        differs substantially from desktop — don't trust desktop numbers
        alone)
  - [ ] 3.3.3 Add downscale-for-detection step if needed to hit <3s (AC #7)
